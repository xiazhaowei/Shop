...
namespace Shop.TimerTask.Utils
{
    ...
    public  class SMSender:ISMSender
    {
        ...
        public bool SendMsgNewOrder(string mobile,string time)
        {
            return Send(mobile, "SMS_113450274", "{\"time\":\""+time+"\"}");
        }
        public bool SendMsgResetPayPassword(string mobile)
        {
            return Send(mobile, "SMS_113455530", "{}");
        }
    }
}