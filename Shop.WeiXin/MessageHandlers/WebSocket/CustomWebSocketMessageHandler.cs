...
namespace Shop.WeiXin.MessageHandlers.WebSocket
{
    /// <summary>
    /// 小程序WebSocket 自定义 WebSocket 处理类
    /// </summary>
    public class CustomWebSocketMessageHandler : WebSocketMessageHandler
    {
        ...
        public override async Task OnMessageReceiced(WebSocketHelper webSocketHandler, ReceivedMessage receivedMessage, string originalData)
        {
            ...
            var appId = WebConfigurationManager.AppSettings["WxOpenAppId"];
            ...
            try
            {
                ...
                var tmResult = Senparc.Weixin.WxOpen.AdvancedAPIs.Template.TemplateApi.SendTemplateMessage(
                    appId, 
                    openId, 
                    "Ap1S3tRvsB8BXsWkiILLz93nhe7S8IgAipZDfygy9Bg", 
                    data,
                    receivedMessage.FormId, 
